...
public class Contact_Us_Steps {
    ...
    public void i_enter_a_first_name() {
        driver.findElement(By.name("first_name")).sendKeys("Fernanda");
    }
    @When("I enter a last name")
    public void i_enter_a_last_name() {
        driver.findElement(By.name("last_name")).sendKeys("Oliveira");
    }
    @When("I enter an email address")
    public void i_enter_an_email_address() {
        driver.findElement(By.name("email")).sendKeys("fer@teste.com.br");
    }
    @When("I enter a comment")
    public void i_enter_a_comment() {
        driver.findElement(By.name("message")).sendKeys("Teste automático");
    }
